...
modifiers_dict['Hi-Intensity Shock Troop Gauntlet'] = {'short': 'Hi-Int Shock Troop Gauntlet',
                                                       'emoji': ':boxing_glove:', 'tough': True}
modifiers_dict['Hi-Intensity Gauntlet (Hunting Grounds)'] = {'short': 'Hi-Int Hunting Grounds', 'emoji': ':dog2:',
                                                             'tough': True}
modifiers_dict['Hi-Intensity Gauntlet (Power Supply Outage)'] = {'short': 'Hi-Int Power Supply',
                                                                 'emoji': ':flashlight:', 'tough': True}
